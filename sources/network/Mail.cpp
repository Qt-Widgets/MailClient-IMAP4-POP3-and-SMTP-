...
void MailBody::serialize(std::vector<std::string>& datalines)
{
	std::string str;
	str.clear();
...
void MailHeader::serialize(std::vector<std::string>& datalines, MailBody* bodyptr)
{
	std::string str;
	str.clear();
