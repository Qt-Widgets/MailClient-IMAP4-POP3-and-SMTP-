...
MailClientCore* mailClientPtr = nullptr;

void mailBoxPoller(MailClientCore* appPtr);

MailClientCore::MailClientCore(int argc, char *argv[])
{
    mailClientPtr = this;
...
MailClientCore::~MailClientCore()
{
}

MailDatabase* MailClientCore::MailDb()
{
	return &mailDb;
}

bool MailClientCore::Initialize()
{
	TcpClient cl;
...
void MailClientCore::StartPollerLoop()
{
	std::thread pollerthread(mailBoxPoller, this);
	pollerthread.detach();
}

void MailClientCore::StartMessageLoop()
{
	LoadProfiles();
...
void MailClientCore::GetProfileList()
{
	std::string response = "";
...
void MailClientCore::GetProfileInformation(std::string& str)
{
	std::string response = "";
...
void MailClientCore::AddProfile(std::string& str)
{
...
void MailClientCore::UpdateProfile(std::string& str)
{
	std::string response = str;
	std::vector<std::string> fields;
	strsplit(str, fields, '|', true);
...
void MailClientCore::RemoveProfile(std::string& str)
{
...
void MailClientCore::SendEmail(std::vector<std::string>& strlist)
{
...
void MailClientCore::GetAccountDirectories(std::string& str)
{
...
void MailClientCore::GetEmails(std::string& str1, std::string& str2)
{
...
void MailClientCore::GetEmailsByTerm(std::string& str1, std::string& str2, std::string& str3)
{
	Profile pf = profileList[str1];
...
void MailClientCore::GetEmailHeader(std::string& profilename, std::string& directory, std::string& uid)
{
...
void MailClientCore::GetEmailBody(std::string& profilename, std::string& directory, std::string& uid)
{
	Profile pr = profileList[profilename];
...
void MailClientCore::RemoveEmail(std::string& profilename, std::string& directory, std::string& uid, std::string& messageid)
{
...
void MailClientCore::FlagEmail(std::string& profilename, std::string& directory, std::string& uid, std::string & flag)
{
	Profile pr = profileList[profilename];
...
void MailClientCore::MarkEmail(std::string& profilename, std::string& directory, std::string& uid)
{
	Profile pr = profileList[profilename];
...
void MailClientCore::PurgeDeleted(std::string& profilename, std::string& directory)
{
	Profile pr = profileList[profilename];
...
void MailClientCore::GetContactList()
{
	std::string response = "";
...
void MailClientCore::GetContactDetails(std::string& contactId)
{
	std::string response = "";
...
void MailClientCore::CreateContact(std::string& userinfo)
{
...
void MailClientCore::UpdateContact(std::string& userinfo)
{
	std::vector<std::string> fieldlist;
...
void MailClientCore::RemoveContact(std::string& contactId)
{
...
void MailClientCore::LoadProfiles()
{
	std::string current_dir, parent_dir, email_dir, profile_dir;
...
void MailClientCore::LoadConfiguration()
{

}

void MailClientCore::SaveConfiguration(std::string& str)
{

}

void MailClientCore::GetConfiguration()
{
	std::string current_dir, parent_dir, email_dir, profile_dir;
