#ifndef _MAIL_CLIENT_CORE
#define _MAIL_CLIENT_CORE
...
class MailClientCore
{
public:
    explicit MailClientCore(int argc, char *argv[]);
    virtual ~MailClientCore();
	bool Initialize();
...
extern MailClientCore* mailClientPtr;
